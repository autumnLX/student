    ...
    div(style='padding-bottom: 10px;')
      div.divide
        div
          div.dashed
          div.text 作业报告
      iframe#report.detail(:src='src' scrolling='no' :style='{height: reportHeight}')
</template>
  ...
  methods: {
    ...
    commented() {
      ...
      let reqParam = {
        ...
        getExpiredReport: getExpiredReport
      }
      this.src = `/web/models/WorkDetail2/self.php?wid=${worksetId}&task=${isTask}&scId=${scId}&layerType=${layerType || 0}&layerId=${layerId || 0}&categoryId=${categoryId || 0}&teacherId=${teacherId || 0}&worksetType=${worksetType || 'self'}&getExpiredReport=${getExpiredReport}`
