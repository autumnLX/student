  ...
  methods: {
    ...
    detailFn(ds) {
      ...
      let _param = {
        ...
        standardAudio: this.detailScore.standardAudio ? (this.detailScore.standardAudio.match(/\.mp3/gi) ? this.detailScore.standardAudio : this.detailScore.standardAudio + '.mp3') : '',
      }
