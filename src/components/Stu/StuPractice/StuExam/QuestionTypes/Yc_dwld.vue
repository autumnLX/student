<template lang="pug">
  div.question-type-yc_dwld
    div.question-content(v-html='contentHtml')
</template>

<script>
export default {
  name: 'QuestionTypePzld',
  ...
  methods: {
    ...
    detailFn(ds) {
      ...
      let _param = {
        ...
        standardAudio: this.detailScore.standardAudio && !this.detailScore.standardAudio.match(/\.mp3/gi) ? this.detailScore.standardAudio + '.mp3' : this.detailScore.standardAudio,
      }
