...
import Process from '@/components/Stu/StuPractice/StuWork/Process' // 当前进度
import Collection from '@/components/Stu/StuPractice/StuWork/Collection' // 收藏
import RecordingAnimation from '@/components/Stu/StuPractice/StuWork/RecordingAnimation' // 录音动画效果
import ScoreAnimation from '@/components/Stu/StuPractice/StuWork/ScoreAnimation' // 得分反馈动画效果
...
export default {
  ...
  components: Object.assign({}, { Left, Process, Collection, RecordingAnimation, ScoreAnimation, Result }, { ...Topics }),
  data() {
    return {
      ...
      currentBoard: 0, // 1 main 2 result
  ...
  methods: {
    ...
    greatAudio(callback = () => { }) {
      if (this.currentSubIndex > 1 && this.detailScore[this.currentSubIndex - 1].score >= 85) {
        this.fantasticNum++
      }
      callback()
    },
    ...
    recordScoreLevelAudio(score, callback = () => { }, subIndex, recordAudioUrl) {
      this.resultStatus = 'nonVip'
      setTimeout(() => {
        this.resultStatus = ''
      }, 1000);
    ...
    setList() {
      ...
      if (this.type === 'conv') {
        ...
        this.contents.forEach((value, index) => {
          ...
          if (this.type === 'corr') {
            param.symbol = /\[*\]/.test(value.symbol) ? value.symbol : `[${value.symbol}]`
            param.randerSymbol = ''
          }
  ...
  & > .stuwork-topic {
    ...
    & > .panel-right {
      ...
      & > .icon_collapse {
        ...
        height: 30px;
        margin-top: -15px;
        background: url("/static/images/practice/btn_collapse.png") no-repeat
          center;
...
.videoPlug {
  ...
  & > .play {
    ...
    height: 75px;
    margin-top: 17px;
    background: url("/static/images/practice/work/work_audio_normal.png")
      no-repeat center;
    cursor: pointer;

    &:hover {
      background: url("/static/images/practice/work/work_audio_hover.png")
        no-repeat center;
    }
    &.playing {
      background: url("/static/images/practice/work/work_voice_palying.png")
        no-repeat center;
      animation: workplaying 1s steps(1) infinite 0s;
    }
    &.readagain {
      background: url("/static/images/practice/work/work_repeat_normal.png")
        no-repeat center;
      &:hover {
        background: url("/static/images/practice/work/work_repeat_hover.png")
          no-repeat center;
      }
    }
    &.disabled {
      background: url("/static/images/practice/work/work_audio_disable.png")
        no-repeat center;
      cursor: not-allowed;
    }
  }
  & > .record {
    ...
    width: 110px;
    height: 110px;
    background: url("/static/images/practice/work/work_record_normal.png")
      no-repeat center;
    cursor: pointer;
    position: relative;

    &:hover {
      background: url("/static/images/practice/work/work_record_hover.png")
        no-repeat center;
    }
    &.recording {
      border-radius: 50%;
      background: #fff url("/static/images/practice/work/work_record_icon.png")
        no-repeat center;
      position: relative;
    }
    &.recite {
      background: url("/static/images/practice/work/work_recite_normal.png")
        no-repeat center;
      &:hover {
        background: url("/static/images/practice/work/work_recite_hover.png")
          no-repeat center;
      }
    }
    &.re_recite {
      background: url("/static/images/practice/work/recite_again_normal.png")
        no-repeat center;
      &:hover {
        background: url("/static/images/practice/work/recite_again_hover.png")
          no-repeat center;
      }
    }
    &.read_again {
      background: url("/static/images/practice/work/read_again_normal.png")
        no-repeat center;
      &:hover {
        background: url("/static/images/practice/work/read_again_hover.png")
          no-repeat center;
      }
    }
    &.disabled {
      background: url("/static/images/practice/work/work_record_disable.png")
        no-repeat center;
      cursor: not-allowed;
    }
  }
  & > .replay {
    ...
    height: 75px;
    margin-top: 17px;
    background: url("/static/images/practice/work/work_voice_normal.png")
      no-repeat center;
    cursor: pointer;

    &:hover {
      background: url("/static/images/practice/work/work_voice_hover.png")
        no-repeat center;
    }
    &.playing {
      background: url("/static/images/practice/work/work_voice_palying.png")
    ...
    &.disabled {
      background: url("/static/images/practice/work/work_voice_disable.png")
        no-repeat center;
      cursor: not-allowed;
    }
    & > audio {
