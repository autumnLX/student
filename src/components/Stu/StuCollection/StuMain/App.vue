...
import BookPractice from '@/components/Stu/StuCollection/StuMain/BookPractice'
import PaperPractice from '@/components/Stu/StuCollection/StuMain/PaperPractice'

export default {
  name: 'StuAggregate',
  props: ['handleErrTwice'],
  components: Object.assign({}, { DiaLog, BookPractice, PaperPractice }),
  data() {
    return {
      nav: [{
        title: '首页',
