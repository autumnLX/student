      ...
      div.kami-charge-body(v-else)
        ...
        div.kami-charge-bottom
          ...
          div.flex-start-center
              ...
              a.f12.green(href='/payment' target='_blank') 《{{ pname }}用户付费协议》
        //- div.kami-charge-bottom
          div.flex-start-center
            i.kami-charge-scan
            span.grey6 支付方式
...
export default {
  ...
  data() {
    return {
      ...
      payInfo: {
        ...
        price: '1.00',
        from: 'web',
        subject: window.ConfigNew.header.name + 'VIP套餐费用',
        body: '续费VIP',
        product_type: '4',
        channel: 'wx_pub_qr'
      },
  ...
  created() {
    ...
    this.$ajax.post('/jdcp/getProductList', {
      productType: '4',
      countryId: this.$store.state.student.districtId,
    }, (res) => {
      const productList = []
